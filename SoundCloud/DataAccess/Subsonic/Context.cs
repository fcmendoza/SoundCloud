...
{
	internal partial class SoundCloudDB : IQuerySurface
	{
		...
		public SoundCloudDB() 
		{ 
			DataProvider = ProviderFactory.GetProvider("SoundCloud");
			Init();
		}

		public SoundCloudDB(string connectionStringName)
		{
			DataProvider = ProviderFactory.GetProvider(connectionStringName);
			Init();
		}

		public SoundCloudDB(string connectionString, string providerName)
		{
